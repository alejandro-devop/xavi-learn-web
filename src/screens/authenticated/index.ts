...
import TestingHallScreen from "./testing-hall-screen";
import ViewCourseScreen from "./courses/view-course-screen";
import ListCoursesScreen from "./courses/list-courses-screen";
import ListHabitsScreen from "./habits/list-habits-screen";
